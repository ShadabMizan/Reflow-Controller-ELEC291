...
VREF_VALUE equ 4106 ; changed to whatever it will be, inshal: measure lm4040d value then change
...
LM335_ADC:
	mov ADC_C, #0x01 ;ADC channel 0 is used
...
adc_to_temp_to_serial:
	mov ADC_C, #0x02 ;ADC channel 0 is used
